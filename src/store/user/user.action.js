...
export const signOutStarted = () => createAction(USER_ACTION_TYPES.SIGN_OUT_STARTED);
export const signOutSucceeded = () => createAction(USER_ACTION_TYPES.SIGN_OUT_SUCCEEDED);
