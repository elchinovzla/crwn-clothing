...
export type SignUpSucceeded = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCEEDED, { user: UserData, aditionalDetails: AdditionalInformation }>
export const signUpSucceeded = withMatcher((user: UserData, aditionalDetails: AdditionalInformation): SignUpSucceeded => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCEEDED, { user, aditionalDetails }));
